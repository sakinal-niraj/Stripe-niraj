        ...
        <>
            <header className='w-full'>
                <nav className='container'>
                    <div className='mt-6  md:pt-3.5 px-2 flex justify-between items-center font-bold'>
                        {/* right side */}
                        <div className='flex items-center justify-center space-x-9'>
                            {/* Logo */}
                            <h1 className="SiteHeader__logo bg-white text-white">
                                <Link to="/"
                        ...
                        <div className='lg:flex space-y-2 space-x-2 items-center hidden'>
                            {/* Sign in */}
                            <div
                                className='flex items-center pt-1 font-bold first-letter:uppercase'
                            ...
                            {/* Contact sales */}
                            <div
                                className='flex items-center font-normal bg-black text-white rounded-full py-1 px-4 pb-1.5 gap-1'
                                onMouseEnter={() => setHovered({ ...hovered, contactSales: true })}
                                onMouseLeave={() => setHovered({ ...hovered, contactSales: false })}
                            >
                                Contact sales
                                <span className='pt-1 font-bold'>{hovered.contactSales ? <BsArrowRightShort /> : <MdKeyboardArrowRight />}</span>
                            </div>
                        </div>
