    ...
    return (
        <div className=''>
            ...
            <div className='relative -z-10 mt-5 md:mt-16 flex justify-between w-full h-full 3xl:justify-center  pl-5 sm:pl-6 md:ml-0 lg:ml-0 2xl:pl-[240px] 3xl:pl-[0px] 3xl:ml-0 overflow-hidden'>
                <div className='flex justify-between 3xl:max-w-[1050px] 3xl:w-full gap-20'>
                    <div className="text-black 3xl:w-full">
                        {/* Preview Tag */}
                        ...
                        {/* Content Section */}
                        <div className="mt-8 w-fu sm:max-w-[540px] mr-[40px] space-y-9 ">
                            {/* Headline */}
                            <h1 className="text-[55px] md:text-[91px] tracking-[-0.06em] leading-[1] text-gray-800 font-bold">
                                Financial infrastructure to grow your revenue
                            </h1>

                            {/* Subheading */}
                            <p className="text-gray-700 font-medium text-lg leading-relaxed md:pr-[40px] w-[340px] sm:w-fit ">
                    ...
                    <div className='w-full relative'>
                        <div className='relative z-30 ml-28 bg-[#ffffff60] w-[1050px] h-[600px] flex items-start gap-2 px-6 py-6 rounded-lg justify-between'>
                            <div className='flex items-center  gap-4'>
                                ...
                                <div class="HomepageDashboardGraphic__searchBar flex items-center h-[20px] bg-white p-1 text-[12px] w-[300px] rounded-sm gap-1 text-[#62788d]">
                            ...
                            <div className='absolute left-[-110px] top-16 z-50 rounded-lg'>
                                <img src={hero1} alt="" className='rounded-[30px] w-[85%] border-[4px] border-[#e7eef6a6]' />
                            </div>

                            <div className='absolute right-[-124px] top-[78px] z-50 '>
