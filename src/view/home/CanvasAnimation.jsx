...
const CanvasAnimation = () => {
    ...
    return (
        <div className=''>
            ...
            <div className='-z-10 mt-5 md:mt-16 w-full flex justify-between pl-5 sm:pl-6 md:ml-10 lg:ml-0 2xl:pl-[240px] 3xl:pl-[470px] 3xl:ml-0 overflow-hidden'>
                <div className='flex justify-around  3xl:max-w-[1050px] overflow-hidden'>
                    ...
                    <div className=' relative w-[1000px] overflow-hidden'>
                        <div className='flex justify-between items-center  bg-[#ffffff2e] p-5 gap-2 rounded-xl absolute'>
                            <div className='flex pr-10'>
                                {/* Rockey side */}
                                <div class="HomepageDashboardGraphic__company flex items-center gap-2 text-white text-[14px] font-[550]">
                                    <svg className='text-white' width="20" height="20" viewBox="0 0 20 20"><path fill="#FFF" d="M10 0a10 10 0 1 1 0 20 10 10 0 0 1 0-20zm3.3 6.11H4.34a.41.41 0 0 0 0 .83h8.94a2.89 2.89 0 0 1 0 5.77H7.65a.41.41 0 0 0 0 .83h5.64a3.71 3.71 0 0 0 0-7.43zm0 1.65a2.06 2.06 0 1 0 2.05 2.06c0-1.13-.92-2.06-2.06-2.06zm-2.83 3.3h-4.7a.41.41 0 0 0 0 .83h4.7a.41.41 0 0 0 0-.83zM13.3 8.6a1.24 1.24 0 1 1 0 2.47 1.24 1.24 0 0 1 0-2.47zm-3.3.8H3.41a.41.41 0 1 0 0 .83h6.6c.22 0 .4-.19.4-.42a.41.41 0 0 0-.41-.4zm.47-1.65H6.24a.41.41 0 1 0 0 .83h4.23a.41.41 0 1 0 0-.83z"></path></svg>
                                    Rocket Rides
                                    <svg width="10" height="4" viewBox="0 0 10 4"><polyline fill="none" stroke="#FFF" points="1 0 5 4 9 0"></polyline></svg>
                                </div>

                                {/* search bar */}
                                <div className="flex items-center h-[20px] px-3 rounded-sm p-[2px] w-[280px] bg-white">
                                    <svg
                                    ...
                                    <span className="text-[#62788d] text-[12px] ">Search</span>
                                </div>
