                    ...
                    <>
                        ...
                        <div className="space-y-8 md:w-1/2 w-full">
                            <div className='space-y-6'>
                                <h2 className="text-[#635BFF] font-bold text-xl pl-[16px] flex items-center gap-2">
                                    {/* svg */}
                                    {item.svg}
                                    {item.title}</h2>
                                ...
                                <p className='ml-[20px] text-white font-semibold flex items-center justify-center pb-[5px] gap-1 px-3 p-1 bg-[#635BFF] rounded-full w-fit'>{item.btn} <span className='pt-[4.5px] font-bold '><MdKeyboardArrowRight /></span></p>

                            </div>
                            <div className='space-y-3 font-bold pl-[16px] '>
